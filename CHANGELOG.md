...
- A Neon section in the `--local-summary` markdown report, which was missing.

### Fixed

- The provider guides and `docs/output-format.md` named the old, untimestamped report file names. They now match what the tool writes.
